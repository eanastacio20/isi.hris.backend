...
public class CompanyHolidayMaster {
	...
	@EmbeddedId
	@AttributeOverrides({
			@AttributeOverride(name = "calendarYear", column = @Column(name = "CalendarYear", nullable = false, length = 4)),
			@AttributeOverride(name = "calendarDate", column = @Column(name = "CalendarDate", nullable = false, length = 10))})
	private CompanyHolidayMasterId id;
	
	@Column(name = "EventName", length = 50)
	private String eventName;
	
	@Column(name = "RepeatFrequency", length = 6)
	...
	@Column(name = "HolidayType", length = 7)
