 ...
 * 
 * @EnableJpaRepositories( basePackages = "com.isi.hris.persistence",
 * entityManagerFactoryRef = "userEntityManager", transactionManagerRef =
 * "userTransactionManager" ) public class PersistenceUserConfiguration {
 * 
 ...
 * em.setPackagesToScan( new String[] { "com.isi.hris.dao" });
 * 
